...
public class ArticleController {
    ...
    public String loadArticle(@PathVariable Integer articleId, Model model){
        ...
        ArticleCustom articleCustom =cacheService.getJson("articleService.getArticleCustomById("+articleId+")",ArticleCustom.class);
        ...
        Article lastArticle = (Article) cacheService.getObj("articleService.getLastArticle("+articleId+")");
        //下一篇
        //Article nextArticle = articleService.getNextArticle(articleId);
        Article nextArticle = (Article) cacheService.getObj("articleService.getNextArticle("+articleId+")");
        //增加浏览量
