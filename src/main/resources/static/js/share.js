...
function loadShareInfo(target) {
	...
	var result = {
        ...
        url:"https://opentest.zhlic.com.cn/"+$(parent).data("url"),
        title:$(parent).data("title"),
        summary:$(parent).data("desc") != null?$(parent).data("desc"):'DaYan个人博客分享,欢迎指教',
        pic:'http://ouhzgqgj4.bkt.clouddn.com/2017/8/11/微信图片_20170811100745.png'
	};
	return result;
